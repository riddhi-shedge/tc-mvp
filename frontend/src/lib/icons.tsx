...
const PATHS: Record<string, string[]> = {
  ...
  contract: [P("M6 2.5h8l4 4V21a.5.5 0 0 1-.5.5h-11A.5.5 0 0 1 6 21z"), P("M14 2.5V6.5h4"), P("M9 10h6"), P("M9 13h6"), P("M9 16.6c.8-.9 1.6.9 2.4 0s1.6.9 2.4 0")],
  ...
  external: [P("M14 4h6v6"), P("M20 4l-8.5 8.5"), P("M18 13v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h5")],
  plus: [P("M12 5v14"), P("M5 12h14")],
  x: [P("M6 6l12 12"), P("M18 6 6 18")],
  bell: [P("M18 8A6 6 0 0 0 6 8c0 6-2 7-2 7h16s-2-1-2-7"), P("M10 20a2 2 0 0 0 4 0")],
  help: ["circle:12,12,9", P("M9.3 9.2a2.8 2.8 0 0 1 5.4 1c0 1.9-2.7 2.2-2.7 4"), P("M12 18h.01")],
  sun: ["circle:12,12,4", P("M12 2v2"), P("M12 20v2"), P("M4 12H2"), P("M22 12h-2"), P("M5.6 5.6 4.2 4.2"), P("M19.8 19.8l-1.4-1.4"), P("M18.4 5.6l1.4-1.4"), P("M5.6 18.4l-1.4 1.4")],
